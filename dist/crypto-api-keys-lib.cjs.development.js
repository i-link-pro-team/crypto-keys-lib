...
var Common__default = _interopDefault(Common);
...
var Common$1 = _interopDefault(require('ethereumjs-common'));
...
})(exports.TransactionMethod || (exports.TransactionMethod = {}));
...
var mnemonicToSeedHex = function mnemonicToSeedHex(mnemonic, password, blockchain) {
  if (blockchain === exports.Blockchain.DOT) {
    return util.u8aToHex(utilCrypto.mnemonicToMiniSecret(mnemonic, password));
  }
          ...
          switch (_context.prev = _context.next) {
            ...
            case 10:
              ...
              for (_iterator3 = _createForOfIteratorHelperLoose(dataObj.inputs.entries()); !(_step3 = _iterator3()).done;) {
                ...
                keyPair = bitcoinjsLib.ECPair.fromWIF(mapPrivateKeys[_input.address], this.networkConfig);
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              hdkey = bip32.fromSeed(Buffer.from(seed, 'hex'), this.networkConfig);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              chain = this.net === exports.Network.MAINNET ? Common.Chain.Mainnet : Common.Chain.Ropsten;
              common = new Common__default({
                chain: chain,
                hardfork: Common.Hardfork.London
              });
              transaction = JSON.parse(data);
              gasPrice = transaction.gasPrice;
              rawTransaction = gasPrice ? tx.Transaction.fromTxData(transaction, {
                common: common
              }) : tx.FeeMarketEIP1559Transaction.fromTxData(transaction, {
                common: common
              });
            ...
            case 12:
              message = addMessagePrefix ? ethUtil.hashPersonalMessage(Buffer.from(data)) : ethUtil.toBuffer(data);
              sign = ethUtil.ecsign(message, ethUtil.toBuffer(privateKeyString));
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              rpc = new eosjs.JsonRpc(JSON.parse(data).endpoint, {
                fetch: fetch
              });
              api = new eosjs.Api({
                rpc: rpc,
            ...
            case 10:
              return _context.abrupt("return", eosUtil.sign(data, privateKey));
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              ...
              return _context.abrupt("return", rippleKeyPair.sign(hash, key.privateKey.toString('hex')));
...
var Polkadot = /*#__PURE__*/function (_BitcoinBase) {
  ...
  function Polkadot(network) {
    ...
    _this = _BitcoinBase.call(this, network) || this;
    _this.networks = (_this$networks = {}, _this$networks[exports.Network.MAINNET] = {
      blockchain: exports.Blockchain.DOT,
      network: exports.Network.MAINNET,
      path: '//44//354//0',
  ...
  _proto.getPublicFromPrivate = function getPublicFromPrivate(privateKey, isWIF) {
    ...
    keyPair.decodePkcs8(this.passphrase, util.hexToU8a(privateKey));
    return util.u8aToHex(keyPair.publicKey);
  };
  ...
  _proto.checkSign = function checkSign(publicKey, data, sign) {
    return this.getKeyring().addFromAddress(publicKey).verify(data, util.stringToU8a(sign), publicKey);
  };
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              keyPair.decodePkcs8(this.passphrase, util.hexToU8a(privateKeyString));
            ...
            case 13:
              return _context.abrupt("return", util.u8aToHex(keyPair.sign(data)));
    ...
    var _getMasterFromSeed = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(seedPhrase, path, password) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              seed = util.u8aToHex(utilCrypto.mnemonicToMiniSecret(seedPhrase, password));
              _context2.next = 3;
          ...
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              return _context3.abrupt("return", {
                masterPrivateKey: util.u8aToHex(masterPair.encodePkcs8(this.passphrase)),
                masterPublicKey: util.u8aToHex(masterPair.publicKey),
                masterAccountPrivateKey: util.u8aToHex(masterAccountPair.encodePkcs8(this.passphrase)),
                masterAccountPublicKey: util.u8aToHex(masterAccountPair.publicKey)
              });
  ...
  _proto.derivateFromPrivate = function derivateFromPrivate(masterPrivateKey, cursor) {
    ...
    if (masterPrivateKey.length === 66) {
      isAccount = false;
      pair = keyring.addFromSeed(util.hexToU8a(masterPrivateKey));
    } else {
      pair = keyring.createFromUri('//ANYPATH');
      pair.decodePkcs8(this.passphrase, util.hexToU8a(masterPrivateKey));
    }
    ...
    return indexes.map(function (index) {
      ...
      return {
        ...
        publicKey: util.u8aToHex(derivedPair.publicKey),
        privateKey: util.u8aToHex(derivedPair.encodePkcs8(_this2.passphrase))
      };
    });
  };
  ...
  _proto.isValidAddress = function isValidAddress(address) {
    try {
      utilCrypto.encodeAddress(util.isHex(address) ? util.hexToU8a(address) : utilCrypto.decodeAddress(address));
      return true;
    } catch (error) {
      return false;
    }
          ...
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              return api.ApiPromise.create({
                provider: new api.WsProvider(POLKA_ANY_API_ENDPOINT)
              });
            ...
            case 14:
              ...
              _context4.next = _context4.t1 === exports.TransactionMethod.TRANSFER ? 18 : _context4.t1 === exports.TransactionMethod.BOND ? 19 : _context4.t1 === exports.TransactionMethod.BOND_EXTRA_AMOUNT ? 20 : _context4.t1 === exports.TransactionMethod.UNBOND_AMOUNT ? 21 : _context4.t1 === exports.TransactionMethod.CHANGE_REWARDS_DESTINATION_ADDRESS ? 22 : _context4.t1 === exports.TransactionMethod.TRANSFER_KEEP_ALIVE ? 23 : _context4.t1 === exports.TransactionMethod.NOMINATE ? 24 : _context4.t1 === exports.TransactionMethod.WITHDRAW_UNBONDED ? 25 : 26;
              break;
  ...
  _proto.getKeyring = function getKeyring() {
    var ss58Format = this.network === exports.Network.MAINNET ? 0 : 42;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (this.net === exports.Network.TESTNET) {
                baseChain = 'ropsten';
                chainId = 97;
                hardfork = 'petersburg';
              }
              ...
              txRaw = new ethereumjsTx.Transaction(transactionObject, {
                common: common
              });
            ...
            case 13:
              hash = ethUtil.hashPersonalMessage(Buffer.from(data));
              sign = ethUtil.ecsign(hash, Buffer.from(privateKey.replace('0x', ''), 'hex'));
              return _context.abrupt("return", JSON.stringify({
                r: sign.r.toString('hex'),
                s: sign.s.toString('hex'),
                v: sign.v
...
var Tron = /*#__PURE__*/function (_BitcoinBase) {
  ...
  function Tron(network) {
    ...
    _this = _BitcoinBase.call(this, network) || this;
    _this.networks = (_this$networks = {}, _this$networks[exports.Network.MAINNET] = {
      blockchain: exports.Blockchain.TRX,
      network: exports.Network.MAINNET,
      path: "m/44'/195'/0'",
      config: tron.mainnet
    }, _this$networks[exports.Network.TESTNET] = {
  ...
  _proto.computeAddress = function computeAddress(pubBytes) {
    ...
    var hash = ethers.utils.keccak256(pubBytes).toString().substring(2);
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              _context6.next = 2;
              return sodiumPlus.SodiumPlus.auto();

            case 2:
              sodium = _context6.sent;
              hashedPassword = createHash('sha256').update(password).digest('hex');
              key = sodiumPlus.CryptographyKey.from(hashedPassword, 'hex');
